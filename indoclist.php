...
<body>
	...
	<tr bgcolor=red><td align=center ><font size=6 color=white>Invalid Doctors
	List</font></td></tr>
	...
	<?php 
		...
		{
			echo "<tr><td align=center>".$row['did']."</td><td align=center>".$row['dname']."</td><td align=center>".$row['dspecial']."</td><td align=center>"."Invalid"."</td></tr>";
		}
